 ...
 * Will see how to avoid inheritance and Overriding
 */

/*Avoiding overriding in java */
class overriding{
...
class overriding1 extends overriding{
    ...
    void show(){
        ...
        System.out.println("This is final sub class");
    }
}

/*Avoiding inheritance in java */
...
public class FinalKeyword {
    public static void main(String[] args) {
        ...
        overriding1 overOB = new overriding1();
        overOB.show();

        myClass myclassOBJ = new myClass();
        myclassOBJ.Print();
        
        myClass myclassOBJ1 = new myClass1();
        myclassOBJ1.Print();
